...
$custom_img = get_field('callout_one_bg_img', 'cta-options');
$bgimg = isset($custom_img['sizes']['extra_large']) ? $custom_img['sizes']['extra_large'] : '';
$title = get_field('callout_one_title', 'cta-options');
$subtitle = get_field('callout_one_subtitle', 'cta-options');
$text = get_field('callout_one_text', 'cta-options');
$btn_text = get_field('callout_one_btn_text', 'cta-options');
$btn_link = get_field('callout_one_btn_link', 'cta-options');
$btn_text2 = get_field('callout_one_btn_text_2', 'cta-options');
$btn_link2 = get_field('callout_one_btn_link_2', 'cta-options');
$callout_mobile = get_field('callout_one_mobile_img', 'cta-options');
$callout_img = isset($callout_mobile['sizes']['extra_large']) ? $callout_mobile['sizes']['extra_large'] : '';
$callout_desk = get_field('callout_one_desktop_img', 'cta-options');
$callout_png = isset($callout_desk['sizes']['extra_large']) ? $callout_desk['sizes']['extra_large'] : '';
?>
<div class="section section-callout section-about-callout bg-white with-image lazyload" data-bg="<?php echo $bgimg; ?>">
